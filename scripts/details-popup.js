...
(() => {
	...
	const createKanjiMaker = (detailsPopup, values) => {
		...
		details.appendChild(itemCardsCreator("Used Radicals", "Kanji", values["kanji"]));

		details.appendChild(itemCardsCreator("Used Radicals", "Vocabulary", values["vocabulary"]));
